  ...
  return (
    <section className="container px-16 lg:px-24 my-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {blogs?.map((blog) => (
          <div className="card bg-base-100 rounded-lg mt-12 cursor-pointer h-[80%]">
            <figure className="h-[40%] w-[100%] ">
              <img src={blog?.blog_img} alt="blogs" className="h-[100%] w-full object-cover" />
            </figure>
